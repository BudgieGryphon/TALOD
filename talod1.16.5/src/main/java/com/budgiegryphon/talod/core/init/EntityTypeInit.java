...
import com.budgiegryphon.talod.common.entities.SweetberryDragonEntity;
...
public class EntityTypeInit {
	...
	public static final RegistryObject<EntityType<SweetberryDragonEntity>> SWEETBERRYDRAGON_ENTITY = 
			ENTITY_TYPES.register("sweetberry_dragon", () -> EntityType.Builder.of(SweetberryDragonEntity::new, 
					EntityClassification.CREATURE).sized(0.5f, 0.5f).build(new ResourceLocation(talod.MOD_ID, "sweetberry_dragon").toString()));
